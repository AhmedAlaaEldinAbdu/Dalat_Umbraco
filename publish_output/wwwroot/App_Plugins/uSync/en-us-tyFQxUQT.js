const e = {
  uSync: {
    ...
    runningInBackground: "uSync is running this process in background, if you navigate away from this page it will continue to run.",
    connectionLost: "the connection to the server has been lost, the process will continue to run in the background but you will not see updates here.",
    importSingle: "Import",
  ...
  USyncSettings: {
    ...
    processingModeDesc: "How the uSync process runs, either in the background or interactively (Normal)",
...
//# sourceMappingURL=en-us-tyFQxUQT.js.map
