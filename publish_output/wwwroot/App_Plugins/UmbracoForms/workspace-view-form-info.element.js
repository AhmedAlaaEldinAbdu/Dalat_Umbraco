...
}, b = (e, t, a) => t.has(e) || v("Cannot " + a), p = (e, t, a) => (b(e, t, "read from private field"), a ? a.call(e) : t.get(e)), y = (e, t, a) => t.has(e) ? v("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), I = (e, t, a, l) => (b(e, t, "write to private field"), t.set(e, a), a), $ = (e, t, a) => (b(e, t, "access private method"), a), o, d, w, z;
const S = "workspace-view-form-info";
let n = class extends T(N) {
  constructor() {
    super(), y(this, d), y(this, o), this._relations = [], this.consumeContext(g, (e) => {
      I(this, o, e), $(this, d, w).call(this);
    });
  }
  render() {
    var e, t, a;
...
w = function() {
  p(this, o) && this.observe(p(this, o).data, async (e) => {
    var t;
    e && (this._form = e, (t = p(this, o)) != null && t.getIsNew() || await $(this, d, z).call(this, e.id));
  });
};
z = async function(e) {
