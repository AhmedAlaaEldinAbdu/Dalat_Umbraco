import { html as v, css as $, property as E, customElement as N } from "@umbraco-cms/backoffice/external/lit";
...
}, h = (e, i, t) => i.has(e) || _("Cannot " + t), r = (e, i, t) => (h(e, i, "read from private field"), t ? t.call(e) : i.get(e)), u = (e, i, t) => i.has(e) ? _("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), b = (e, i, t, m) => (h(e, i, "write to private field"), i.set(e, t), t), s = (e, i, t) => (h(e, i, "access private method"), t), p, n, a, F, x, o, S, w, M, P, g;
      ...
      (e, i) => v` <div class="umb-forms-mapping">
            ...
            >
              <uui-input
                ...
                .value=${e.keyName || ""}
                @change=${(t) => s(this, a, P).call(this, t, i)}
              ></uui-input>
            </div>
          </div>`
    )}
