...
var _ = (r, a, e) => a.has(r) || N("Cannot " + e);
var n = (r, a, e) => (_(r, a, "read from private field"), e ? e.call(r) : a.get(r)), d = (r, a, e) => a.has(r) ? N("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(r) : a.set(r, e), g = (r, a, e, t) => (_(r, a, "write to private field"), t ? t.call(r, e) : a.set(r, e), e), E = (r, a, e) => (_(r, a, "access private method"), e);
import { c as A, v as U, w as D, x, y as M, z, G as V, A as B } from "./index.js";
...
}, W = (r, a, e) => a.has(r) || O("Cannot " + e), P = (r, a, e) => (W(r, a, "read from private field"), a.get(r)), R = (r, a, e) => a.has(r) ? O("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(r) : a.set(r, e), le = (r, a, e, t) => (W(r, a, "write to private field"), a.set(r, e), e), k = (r, a, e) => (W(r, a, "access private method"), e), y, S, b, I;
const ue = "forms-form-workspace-editor";
let f = class extends $(
  X
) {
  constructor() {
    super(), R(this, S), this._formName = "", R(this, y), this.consumeContext(A, (r) => {
...
class pe extends Q {
  ...
  async load(e) {
    ...
    t && (this.setIsNew(!1), n(this, l).update(t), this.view.setTitle(t.name || ""));
  }
  async create(e, t) {
    g(this, m, e);
    ...
    }), this.setIsNew(!0), n(this, l).setValue(i), this.view.setTitle("New Form"), { data: i };
  }
  async requestSave() {
    await this.submit();
  }
  ...
  setContainerProperty(e, t, s, i, o) {
    var p;
    const u = (p = n(this, l).value) == null ? void 0 : p.pages[e].fieldSets[t].containers.map((h, c) => ({
      ...h,
      ...c === s && {
        [i]: o
      }
  ...
  setFieldProperty(e, t, s, i, o, u) {
    var h;
    const p = (h = n(this, l).value) == null ? void 0 : h.pages[e].fieldSets[t].containers[s].fields.map((c, C) => ({
      ...c,
      ...C === i && {
        [o]: u
      }
  ...
  moveField(e, t, s) {
    ...
    const i = structuredClone((o = n(this, l).value) == null ? void 0 : o.pages);
    if (i) {
      const u = E(this, F, T).call(this, i, t), p = E(this, F, T).call(this, i, s), h = u.fields.findIndex(
        (C) => C.id == e
      ), c = u.fields.splice(h, 1)[0];
      p.fields.push(c), this.setFormProperty("pages", i);
    }
  }
  moveWorkflow(e, t, s) {
    ...
    for (let s = 0; s < t.pages.length; s++) {
      ...
      for (let o = 0; o < i.fieldSets.length; o++) {
        ...
        for (let p = 0; p < u.containers.length; p++) {
          const h = u.containers[p];
          for (let c = 0; c < h.fields.length; c++)
            if (h.fields[c].id === e)
              return s + "_" + o + "_" + p;
        }
      }
