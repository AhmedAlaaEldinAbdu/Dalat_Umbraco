import { X as T, W as C, a8 as R } from "./index.js";
import "@umbraco-cms/backoffice/id";
import "@umbraco-cms/backoffice/resources";
import "@umbraco-cms/backoffice/repository";
import { when as m, html as c, customElement as $ } from "@umbraco-cms/backoffice/external/lit";
...
var b = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var l = u > 1 ? void 0 : u ? b(t, s) : t, h = e.length - 1, f; h >= 0; h--)
    (f = e[h]) && (l = f(l) || l);
  return l;
}, _ = (e, t, s) => t.has(e) || y("Cannot " + s), r = (e, t, s) => (_(e, t, "read from private field"), s ? s.call(e) : t.get(e)), d = (e, t, s) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), I = (e, t, s, u) => (_(e, t, "write to private field"), t.set(e, s), s), o = (e, t, s) => (_(e, t, "access private method"), s), a, n, i, v, E, S, U, w;
const F = "forms-user-security-create-options-modal";
let p = class extends g {
  constructor() {
    super(), d(this, i), d(this, a, []), d(this, n, new T(this)), o(this, i, v).call(this);
  }
  render() {
    return c`
      <umb-body-layout
...
v = async function() {
  const { data: e } = await r(this, n).requestUsersToAssign();
  I(this, a, e), this.requestUpdate();
};
E = async function() {
...
U = async function(e) {
  const { data: t } = await r(this, n).createScaffold({ unique: e });
  t && await r(this, n).create(t, null);
};
w = async function() {
  const e = new O({
    entityType: R,
