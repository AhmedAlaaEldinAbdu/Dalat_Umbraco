...
var A = Object.defineProperty, M = Object.getOwnPropertyDescriptor, f = (e) => {
  throw TypeError(e);
}, d = (e, t, r, l) => {
  for (var a = l > 1 ? void 0 : l ? M(t, r) : t, o = e.length - 1, p; o >= 0; o--)
    (p = e[o]) && (a = (l ? p(t, r, a) : p(a)) || a);
  return l && a && A(t, r, a), a;
}, h = (e, t, r) => t.has(e) || f("Cannot " + r), u = (e, t, r) => (h(e, t, "read from private field"), r ? r.call(e) : t.get(e)), _ = (e, t, r) => t.has(e) ? f("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), O = (e, t, r, l) => (h(e, t, "write to private field"), t.set(e, r), r), c = (e, t, r) => (h(e, t, "access private method"), r), i, s, E, g, y;
const U = "forms-email-template-picker-property-editor", m = "Forms/Emails";
let n = class extends C {
  ...
  set value(e) {
    const t = u(this, i);
    O(this, i, e), this.requestUpdate("value", t);
  }
  render() {
    return v` ${F(
      this.value.length > 0,
