import { when as _, html as h, property as F, state as u, customElement as T } from "@umbraco-cms/backoffice/external/lit";
...
var g = Object.defineProperty, C = Object.getOwnPropertyDescriptor, y = (e) => {
  ...
  for (var a = s > 1 ? void 0 : s ? C(t, r) : t, d = e.length - 1, n; d >= 0; d--)
    (n = e[d]) && (a = (s ? n(t, r, a) : n(a)) || a);
