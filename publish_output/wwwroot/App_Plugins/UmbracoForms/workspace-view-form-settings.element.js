...
}, _ = (t, e, s) => e.has(t) || v("Cannot " + s), m = (t, e, s) => (_(t, e, "read from private field"), s ? s.call(t) : e.get(t)), d = (t, e, s) => e.has(t) ? v("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, s), g = (t, e, s, o) => (_(t, e, "write to private field"), e.set(t, s), s), b = (t, e, s) => (_(t, e, "access private method"), s), i, n, c, w;
const k = "workspace-view-form-settings";
let a = class extends M(F) {
  constructor() {
    super(), d(this, c), d(this, i), d(this, n, !1), this.consumeContext(y, (t) => {
      g(this, i, t), b(this, c, w).call(this);
