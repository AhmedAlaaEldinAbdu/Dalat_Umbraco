...
import { O as v, T as f } from "./index.js";
...
var T = Object.getOwnPropertyDescriptor, _ = (e) => {
  throw TypeError(e);
}, w = (e, t, a, o) => {
  for (var r = o > 1 ? void 0 : o ? T(t, a) : t, s = e.length - 1, p; s >= 0; s--)
    (p = e[s]) && (r = p(r) || r);
  return r;
}, m = (e, t, a) => t.has(e) || _("Cannot " + a), u = (e, t, a) => (m(e, t, "read from private field"), a ? a.call(e) : t.get(e)), n = (e, t, a) => t.has(e) ? _("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), M = (e, t, a, o) => (m(e, t, "write to private field"), t.set(e, a), a), O = (e, t, a) => (m(e, t, "access private method"), a), i, l, c, h;
