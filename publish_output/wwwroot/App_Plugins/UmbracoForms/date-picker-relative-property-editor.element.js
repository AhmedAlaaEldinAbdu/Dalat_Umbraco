...
var w = Object.defineProperty, $ = Object.getOwnPropertyDescriptor, d = (t) => {
  throw TypeError(t);
}, l = (t, e, a, n) => {
  for (var r = n > 1 ? void 0 : n ? $(e, a) : e, o = t.length - 1, p; o >= 0; o--)
    (p = t[o]) && (r = (n ? p(e, a, r) : p(r)) || r);
  return n && r && w(e, a, r), r;
}, k = (t, e, a) => e.has(t) || d("Cannot " + a), C = (t, e, a) => e.has(t) ? d("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), c = (t, e, a) => (k(t, e, "access private method"), a), s, _, m, f;
