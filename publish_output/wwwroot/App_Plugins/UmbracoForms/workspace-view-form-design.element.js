import { c as I, d as U, H as D, I as q, J as H } from "./index.js";
import { UmbTextStyles as N } from "@umbraco-cms/backoffice/style";
import { LitElement as V, when as y, html as f, css as J, state as P, queryAsync as j, customElement as B } from "@umbraco-cms/backoffice/external/lit";
...
}, T = (e, t, i) => t.has(e) || E("Cannot " + i), r = (e, t, i) => (T(e, t, "read from private field"), i ? i.call(e) : t.get(e)), c = (e, t, i) => t.has(e) ? E("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), m = (e, t, i, o) => (T(e, t, "write to private field"), t.set(e, i), i), l = (e, t, i) => (T(e, t, "access private method"), i), u, M, _, $, d, S, a, A, k, O, v, w, g, C, F, W, z, x, R;
const L = "workspace-view-form-design";
let h = class extends G(V) {
  constructor() {
    super(), c(this, a), this._sortModeActive = !1, c(this, u), c(this, M), c(this, _), c(this, $), c(this, d, []), c(this, S, []), c(this, v, -1), c(this, w, !1), c(this, g, -1), m(this, $, Promise.all([
...
A = async function() {
  var i;
  if (await r(this, $), !r(this, u)) return;
  m(this, _, new D(
    this,
    r(this, u)
  )), this.provideContext(q, r(this, _));
  const e = new H(this), { data: t } = await e.requestCollection();
  m(this, S, (t == null ? void 0 : t.items) || []), this.observe(r(this, u).data, (o) => {
    var s;
    o && (this._form = o, r(this, u) && m(this, d, (s = r(this, u)) == null ? void 0 : s.getAllFields()), l(this, a, C).call(this));
  }), this.observe((i = r(this, M)) == null ? void 0 : i.userSecurity, (o) => {
