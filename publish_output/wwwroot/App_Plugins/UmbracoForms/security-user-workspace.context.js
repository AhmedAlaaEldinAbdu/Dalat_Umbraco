import { V as v, W as S, X as f } from "./index.js";
...
var O = Object.defineProperty, x = Object.getOwnPropertyDescriptor, h = (e) => {
  throw TypeError(e);
}, _ = (e, t, r, s) => {
  for (var a = s > 1 ? void 0 : s ? x(t, r) : t, n = e.length - 1, p; n >= 0; n--)
    (p = e[n]) && (a = (s ? p(t, r, a) : p(a)) || a);
  return s && a && O(t, r, a), a;
}, m = (e, t, r) => t.has(e) || h("Cannot " + r), u = (e, t, r) => (m(e, t, "read from private field"), t.get(e)), l = (e, t, r) => t.has(e) ? h("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), T = (e, t, r, s) => (m(e, t, "write to private field"), t.set(e, r), r), P = (e, t, r) => (m(e, t, "access private method"), r), i, c, d;
...
let o = class extends E(
  ...
  constructor() {
    super(), l(this, c), this._name = "", l(this, i), this.consumeContext(y, (e) => {
      T(this, i, e), P(this, c, d).call(this);
    });
  }
  render() {
