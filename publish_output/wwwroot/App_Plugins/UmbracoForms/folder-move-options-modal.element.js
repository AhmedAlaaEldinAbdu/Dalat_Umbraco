import { a5 as E, a4 as b, a2 as y, a3 as O } from "./index.js";
...
var $ = Object.defineProperty, D = Object.getOwnPropertyDescriptor, v = (e) => {
  throw TypeError(e);
}, f = (e, t, o, a) => {
  for (var i = a > 1 ? void 0 : a ? D(t, o) : t, l = e.length - 1, n; l >= 0; l--)
    (n = e[l]) && (i = (a ? n(t, o, i) : n(i)) || i);
  return a && i && $(t, o, i), i;
}, M = (e, t, o) => t.has(e) || v("Cannot " + o), c = (e, t, o) => (M(e, t, "read from private field"), o ? o.call(e) : t.get(e)), _ = (e, t, o) => t.has(e) ? v("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, o), s = (e, t, o) => (M(e, t, "access private method"), o), u, r, F, h, T, m;
let d = class extends g {
  ...
  async connectedCallback() {
    ...
    const e = await c(this, u).requestByUnique(this.data.unique);
...
T = async function(e) {
  ...
  const a = s(this, r, h).call(this), { error: i } = await c(this, u).moveFolder(
    this.data.unique,
    a
  );
  if (i)
