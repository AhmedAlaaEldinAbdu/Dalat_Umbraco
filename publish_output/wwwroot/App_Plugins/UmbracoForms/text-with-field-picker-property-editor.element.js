    ...
    return E`
      ...
      ${s(this, i, f).call(this) ? E`
          ...
          ` : E`
            <div class="text-with-field-picker-margin-div">
              <uui-select
                .options=${r(this, _).map((t) => ({
      name: t.caption,
      value: t.alias,
      selected: t.alias === s(this, i, v).call(this, r(this, a))
    })) ?? []}
...
C = function() {
  o(this, _, r(this, u).getAllFields());
};
x = function(t) {
  this.inputMode = t;
};
P = function(t) {
  ...
  s(this, i, O).call(this, e) ? o(this, a, s(this, i, v).call(this, e)) : o(this, a, e), s(this, i, y).call(this);
};
T = function(t) {
...
O = function(t) {
  return s(this, i, p).call(this, t) ? r(this, u).getAllFields().map(
    (l) => l.alias
  ).includes(s(this, i, v).call(this, t)) : !1;
};
f = function() {
