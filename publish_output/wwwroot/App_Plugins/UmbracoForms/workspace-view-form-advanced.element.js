...
}, d = (e, t, r) => t.has(e) || l("Cannot " + r), p = (e, t, r) => (d(e, t, "read from private field"), t.get(e)), _ = (e, t, r) => t.has(e) ? l("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), F = (e, t, r, s) => (d(e, t, "write to private field"), t.set(e, r), r), b = (e, t, r) => (d(e, t, "access private method"), r), o, v, m;
const k = "workspace-view-form-advanced";
let i = class extends C(h) {
  constructor() {
    super(), _(this, v), _(this, o), this.consumeContext(f, (e) => {
      F(this, o, e), b(this, v, m).call(this);
    });
  }
  render() {
    return w`<uui-box>
