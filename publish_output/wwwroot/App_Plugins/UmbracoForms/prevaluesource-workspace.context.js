...
var _ = (t, s, e) => s.has(t) || T("Cannot " + e);
var i = (t, s, e) => (_(t, s, "read from private field"), e ? e.call(t) : s.get(t)), h = (t, s, e) => s.has(t) ? T("Cannot add the same private member more than once") : s instanceof WeakSet ? s.add(t) : s.set(t, e), y = (t, s, e, r) => (_(t, s, "write to private field"), r ? r.call(t, e) : s.set(t, e), e), f = (t, s, e) => (_(t, s, "access private method"), e);
import { N as C, O as U, Q as I, T as F, k } from "./index.js";
...
class Z extends z {
  constructor(e) {
    ...
    h(this, m);
    h(this, p);
    this.prevalueSourceRepository = new U(this), this.prevalueSourceTypeRepository = new I(this), y(this, o, new O(void 0)), this.data = i(this, o).asObservable(), this.unique = i(this, o).asObservablePart((r) => r == null ? void 0 : r.unique), this.name = i(this, o).asObservablePart((r) => r == null ? void 0 : r.name), this.id = i(this, o).asObservablePart((r) => r == null ? void 0 : r.unique), y(this, p, new O([])), this.prevalues = i(this, p).asObservable(), this.routes.setRoutes([
      {
        path: "create/:type",
        component: l,
        setup: async (r, a) => {
  ...
  async load(e) {
    ...
    r && (this.setIsNew(!1), i(this, o).update(r), this.view.setTitle(r.name || ""), await f(this, v, E).call(this, r.unique));
  }
  async create(e) {
    var u;
