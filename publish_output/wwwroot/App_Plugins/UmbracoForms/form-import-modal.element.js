import { b as F, z as p } from "./index.js";
...
}, d = (t, e, r) => e.has(t) || _("Cannot " + r), C = (t, e, r) => (d(t, e, "read from private field"), r ? r.call(t) : e.get(t)), c = (t, e, r) => e.has(t) ? _("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), u = (t, e, r) => (d(t, e, "access private method"), r), n, s, y, f;
...
f = async function(t) {
  var r;
  const e = (r = t.target.value) == null ? void 0 : r.temporaryFileId;
