...
var C = Object.getOwnPropertyDescriptor, d = (e) => {
  ...
  for (var o = i > 1 ? void 0 : i ? C(t, r) : t, n = e.length - 1, u; n >= 0; n--)
    (u = e[n]) && (o = u(o) || o);
  return o;
}, c = (e, t, r) => t.has(e) || d("Cannot " + r), S = (e, t, r) => (c(e, t, "read from private field"), r ? r.call(e) : t.get(e)), p = (e, t, r) => t.has(e) ? d("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), $ = (e, t, r, i) => (c(e, t, "write to private field"), t.set(e, r), r), _ = (e, t, r) => (c(e, t, "access private method"), r), s, a, h, v;
const M = "forms-prevaluesource-create-options-modal";
let l = class extends y {
  constructor() {
    super(), p(this, a), p(this, s, []), _(this, a, h).call(this);
  }
  render() {
...
h = async function() {
  ...
  $(this, s, (t == null ? void 0 : t.items) || []), this.requestUpdate();
};
v = function(e) {
