import { w, a2 as E, a3 as M } from "./index.js";
...
var F = Object.getOwnPropertyDescriptor, v = (e) => {
  throw TypeError(e);
}, g = (e, t, a, o) => {
  for (var s = o > 1 ? void 0 : o ? F(t, a) : t, l = e.length - 1, D; l >= 0; l--)
    (D = e[l]) && (s = D(s) || s);
  return s;
}, f = (e, t, a) => t.has(e) || v("Cannot " + a), i = (e, t, a) => (f(e, t, "read from private field"), a ? a.call(e) : t.get(e)), c = (e, t, a) => t.has(e) ? v("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), h = (e, t, a, o) => (f(e, t, "write to private field"), t.set(e, a), a), O = (e, t, a) => (f(e, t, "access private method"), a), u, n, d, r, p, R;
let _ = class extends y {
  constructor() {
    super(...arguments), c(this, p), c(this, u), c(this, n), c(this, d), c(this, r, new w(this));
  }
...
R = async function(e) {
  ...
  if (e.stopPropagation(), (t = this.data) != null && t.unique) {
    ...
    const o = await this.getContext(T), s = {
      entityType: a.parentUnique ? E : M,
