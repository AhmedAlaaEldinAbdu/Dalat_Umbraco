...
import { c as h } from "./index-CDhOA-hq.js";
...
}, T = (t, e, a) => e.has(t) || b("Cannot " + a), k = (t, e, a) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, a), u = (t, e, a) => (T(t, e, "access private method"), a), i, y, f, p, _;
let c = class extends w {
  ...
  renderHistory() {
    const t = this.history.map((e) => l`<uui-table-row
        ...
        <uui-table-cell
          >${this.localize.date(e.date, z)}</uui-table-cell
        ></uui-table-row
      >`);
...
f = function() {
  E(this, {
    ...
    await u(this, i, p).call(this), await u(this, i, y).call(this);
  }).catch(() => {
  });
};
p = async function() {
...
//# sourceMappingURL=history-view.element-CEcoPRwI.js.map
