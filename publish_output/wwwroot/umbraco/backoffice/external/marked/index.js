...
g.Hooks = A;
g.parse = g;
var Ye = g.options, et = g.setOptions, tt = g.use, rt = g.walkTokens, st = g.parseInline, nt = g, lt = m.parse, it = w.lex;
export {
  A as Hooks,
  w as Lexer,
  Ve as Marked,
